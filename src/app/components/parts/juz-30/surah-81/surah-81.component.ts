...
@Component({
  ...
  templateUrl: './surah-81.component.html',
  styleUrls: ['./surah-81.component.css']
})
export class Surah81Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.titleService.setTitle('هدى وتدبر - سورة التكوير (تفسير وتدبر)');
    
    // Dynamisk Meta-beskrivning för sökmotorer
    this.metaService.updateTag({ 
      name: 'description', 
      content: 'تدبر وتفسير سورة التكوير من تفسير ابن كثير، السعدي، ابن القيم، وابن عثيمين. تأمل أحداث انقلاب النظام الكوني وأهوال يوم القيامة وعظمة الوحي.' 
    });
  }
  ...
  playAyah(ayahNum: number) {
    const surahNum = 81; // 👈 سورة التكوير ثابته وصحيحة
