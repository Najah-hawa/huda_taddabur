export const alfatiha: Record<string, any> = {
  ...
  en: {
    ...
    verses: [
      ...
      { number: 3, text: 'الرَّحْمَٰنِ الرَّحِيمِ', tafsir: '<b>The Entirely Merciful</b>: Possessor of general mercy for all creation. <br> <b>The Especially Merciful</b>: Possessor of specific mercy for believers.' },
      { number: 4, text: 'مَٰلِكِ يَوۡمِ ٱلدِّينِ', tafsir: 'Master of the <b>Day of Judgment</b>, the Day when deeds are recompensed, rewarding the obedient and punishing the disobedient.' },
      { number: 5, text: 'إِيَّاكَ نَعۡبُدُ وَإِيَّاكَ نَسۡتَعِينُ', tafsir: 'You alone we worship and You alone we ask for help. We do not worship nor seek help except from You, as all matters are in Your hands.' },
      { number: 6, text: 'ٱهۡدِنَا ٱلصِّرَٰطَ ٱلۡمُسۡتَقِيمَ', tafsir: 'Guide us, direct us, and keep us firm on the Straight Path, the path of truth that leads to Your pleasure and Paradise.' },
      { number: 7, text: 'صِرَٰطَ ٱلَّذِينَ أَنۡعَمۡتَ عَلَيۡهِمۡ غَيۡرِ ٱلۡمَغۡضُوبِ عَلَيۡهِمۡ وَلَا ٱلضَّآلِّينَ', tafsir: '<b>The path of those You have blessed</b>: The path of the <b>Prophets</b>, the <b>Truthful</b>, the <b>Martyrs</b>, and the <b>Righteous</b>. <br> <b>Not of those who earned anger</b>: Those who knew the truth but abandoned it. <br> <b>Nor of those who are astray</b>: Those who were ignorant of the truth and strayed from it.' }
    ],
    rubtTassweerySections: [
