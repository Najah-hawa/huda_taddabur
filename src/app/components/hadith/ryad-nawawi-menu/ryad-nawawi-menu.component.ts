...
@Component({
  selector: 'app-ryad-nawawi-menu',
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive],
  templateUrl: './ryad-nawawi-menu.component.html',
  styleUrl: './ryad-nawawi-menu.component.css'
})
export class RyadNawawiMenuComponent implements OnInit { // Implementera OnInit
