...
import { hadithDetails, hadithImportanceList, hadithFawaedList} from './hadith21-data';

@Component({
  selector: 'app-hadith-20',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
  templateUrl: './hadith-21.component.html',
  styleUrl: './hadith-21.component.css'
})

export class Hadith21Component implements OnInit, OnDestroy {
...
ngOnInit() {
  // تعيين عنوان الصفحة
  this.titleService.setTitle('باب التوبة. الحديث التاسع- شرح رياض الصالحين');
