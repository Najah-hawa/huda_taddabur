...
import { hadithDetails, hadithImportanceList, hadithFawaedList} from './hadith20-data';
...
@Component({
  ...
  templateUrl: './hadith-20.component.html',
  styleUrl: './hadith-20.component.css'
})

export class Hadith20Component implements OnInit, OnDestroy {
...
ngOnInit() {
  // تعيين عنوان الصفحة
  this.titleService.setTitle('باب التوبة. الحديث الثامن- شرح رياض الصالحين');
