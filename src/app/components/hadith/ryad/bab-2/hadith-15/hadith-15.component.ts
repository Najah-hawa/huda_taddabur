...
import { hadithDetails, hadithImportanceList, hadithFawaedList} from './hadith15-data';

@Component({
  selector: 'app-hadith-15',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
  templateUrl: './hadith-15.component.html',
  styleUrl: './hadith-15.component.css'
})

export class Hadith15Component implements OnInit, OnDestroy {
