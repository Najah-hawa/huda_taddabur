...
import { hadithDetails, hadithImportanceList, hadithFawaedList, hadithFawaed} from './hadith14-data';

@Component({
  selector: 'app-hadith-14',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
  templateUrl: './hadith-14.component.html',
  styleUrl: './hadith-14.component.css'
})

export class Hadith14Component implements OnInit, OnDestroy {
...
ngOnInit() {
  // تعيين عنوان الصفحة
  this.titleService.setTitle('باب التوبة. الحديث الرابع عشر - شرح رياض الصالحين');
  ...
  this.metaService.updateTag({ 
    property: 'og:title', 
    content: 'باب التوبة. الحديث الرابع عشر - شرح رياض الصالحين'
  });
