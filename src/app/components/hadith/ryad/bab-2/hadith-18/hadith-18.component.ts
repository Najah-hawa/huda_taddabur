...
import { hadithDetails, hadithImportanceList, hadithFawaedList} from './hadith18-data';

@Component({
  selector: 'app-hadith-18',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
  templateUrl: './hadith-18.component.html',
  styleUrl: './hadith-18.component.css'
})

export class Hadith18Component implements OnInit, OnDestroy {
...
ngOnInit() {
  // تعيين عنوان الصفحة
  this.titleService.setTitle('باب التوبة. الحديث السادس- شرح رياض الصالحين');
