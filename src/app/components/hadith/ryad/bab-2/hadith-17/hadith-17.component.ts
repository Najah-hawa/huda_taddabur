...
import { hadithDetails, hadithImportanceList} from './hadith17-data';

@Component({
  selector: 'app-hadith-17',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
  templateUrl: './hadith-17.component.html',
  styleUrl: './hadith-17.component.css'
})

export class Hadith17Component implements OnInit, OnDestroy {
...
ngOnInit() {
  // تعيين عنوان الصفحة
  this.titleService.setTitle('باب التوبة. الحديث السابع عشر - شرح رياض الصالحين');
  ...
  this.metaService.updateTag({ 
    property: 'og:title', 
    content: 'باب التوبة. الحديث السابع عشر - شرح رياض الصالحين'
  });
