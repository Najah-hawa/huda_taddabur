...
import { hadithDetails, hadithImportanceList, hadithFawaedList} from './hadith19-data';

@Component({
  selector: 'app-hadith-19',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
  templateUrl: './hadith-19.component.html',
  styleUrl: './hadith-19.component.css'
})

export class Hadith19Component implements OnInit, OnDestroy {
