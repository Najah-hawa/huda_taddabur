...
import { hadithDetails, hadithImportanceList} from './hadith23-data';

@Component({
  selector: 'app-hadith-23',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
  templateUrl: './hadith-23.component.html',
  styleUrl: './hadith-23.component.css'
})

export class Hadith23Component implements OnInit, OnDestroy {
...
ngOnInit() {
  // تعيين عنوان الصفحة
  this.titleService.setTitle('باب التوبة. الحديث الحادي عشر - شرح رياض الصالحين');
  ...
  this.metaService.updateTag({ 
    property: 'og:title', 
    content: 'باب التوبة. الحديث الخامس - شرح رياض الصالحين'
  });
