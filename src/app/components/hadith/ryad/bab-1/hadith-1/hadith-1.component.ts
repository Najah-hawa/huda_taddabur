...
import { hadithDetails, hadithImportanceList, hadithFawaedList, hadithFawaed1,  hadithFawaed2} from './hadith1-data';

@Component({
  selector: 'app-hadith-1',
  standalone: true,
  imports: [ CommonModule, RouterModule, FooterInfoComponent, NextBeforeSurahMenyComponent, ZoomControlsComponent ],
   templateUrl: './hadith-1.component.html',
  styleUrl: './hadith-1.component.css'
})

export class Hadith1Component implements OnInit, OnDestroy {
...
ngOnInit() {
  this.titleService.setTitle('الحديث الأول: إنما الأعمال بالنيات وأهمية الإخلاص - شروح الأربعين النووية');
  
  this.metaService.updateTag({
    name: 'description',
    content: 'شرح وتدبر الحديث الأول عن أمير المؤمنين عمر بن الخطاب الفاروق (إنما الأعمال بالنيات)، وبيان أن النية ثلث الإسلام، وقصة مهاجر أم قيس، وأثر النية في تحويل العادات إلى عبادات.'
  });
  
  this.metaService.updateTag({
    name: 'keywords',
    content: 'الحديث الأول, إنما الأعمال بالنيات, عمر بن الخطاب, الفاروق, النية والإخلاص, مهاجر أم قيس, ثلث الإسلام, تحويل المباحات إلى قربات, شروح الأربعين النووية'
  });
  
  this.metaService.updateTag({ 
    property: 'og:title', 
    content: 'الحديث الأول: إنما الأعمال بالنيات - تدبر تفاعلي' 
  });
  
  this.metaService.updateTag({ 
    property: 'og:description', 
    content: 'استمع إلى الحديث الشريف بالتظليل التزامني، وتعرّف على السيرة العطرة للفاروق عمر بن الخطاب، وكيف تتضاعف حسنات العمل الواحد بتعدد النوايا الصالحة.' 
  });
