...
@Component({
  ...
  templateUrl: './hadith-12.component.html',
  styleUrl: './hadith-12.component.css'
})

export class Hadith12Component implements OnInit, OnDestroy {
...
ngOnInit() {
  this.titleService.setTitle('الحديث الثاني عشر: قصة أصحاب الغار - شروح الأربعين النووية');
  
  this.metaService.updateTag({
    name: 'description',
    content: 'شرح وتدبر الحديث الثاني عشر (قصة أصحاب الغار)، مع بيان فضل التوسل إلى الله بصالح الأعمال وقت الكرب، وعظم أجر بر الوالدين، العفاف، وحفظ الأمانات.'
  });
  
  this.metaService.updateTag({
    name: 'keywords',
    content: 'قصة أصحاب الغار, الحديث الثاني عشر, الصخرة, التوسل بصالح الأعمال, بر الوالدين, العفاف, الأمانة, ابن عمر, الأربعون النووية, شرح الحديث'
  });
  
  this.metaService.updateTag({ 
    property: 'og:title', 
    content: 'الحديث الثاني عشر: قصة أصحاب الغار - تدبر تفاعلي' 
  });
  
  this.metaService.updateTag({ 
    property: 'og:description', 
    content: 'اقرأ واستمع إلى متن الحديث الثاني عشر مع التظليل التزامني، تفسير المفردات الغامضة، والدروس المستفادة من قصص الثلاثة الذين انطبقت عليهم الصخرة.' 
  });
