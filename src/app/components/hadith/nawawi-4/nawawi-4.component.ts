...
ngOnInit() {
  ...
  this.titleService.setTitle('الحديث الرابع: أطوار خلق الإنسان وخاتمته - شروح الأربعين النووية');

  // 🌐 تعيين وسوم الميتا الأساسية للسيو (Meta Tags)
  this.metaService.updateTag({ 
    name: 'description', 
    content: 'شرح وتدبر الحديث الرابع من الأربعين النووية (أطوار خلق الإنسان وخاتمته). بيان مراحل الجنين في بطن أمه، نفخ الروح، إثبات القدر وعلامات حسن وسوء الخاتمة.' 
  });
  this.metaService.updateTag({ 
    name: 'keywords', 
    content: 'الحديث الرابع, أطوار خلق الإنسان, مراحل الجنين, نفخ الروح, الصادق المصدوق, القدر, حسن الخاتمة, سوء الخاتمة, الأربعون النووية, شرح الأربعين النووية' 
  });
  
  // 📱 وسوم الميتا الخاصة بشبكات التواصل الاجتماعي (Open Graph)
  this.metaService.updateTag({ property: 'og:title', content: 'الحديث الرابع: أطوار خلق الإنسان وخاتمته - تدبر تفاعلي متزامن' });
  this.metaService.updateTag({ property: 'og:description', content: 'استمع إلى متن حديث ابن مسعود رضي الله عنه مع تظليل النص المتزامن وشرح مفصل لعقيدة القدر ومراحل خلق الإنسان والفوائد المستفادة.' });
