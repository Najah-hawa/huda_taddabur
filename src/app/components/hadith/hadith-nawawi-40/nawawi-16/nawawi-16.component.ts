...
@Component({
  ...
  styleUrl: './nawawi-16.component.css'
})

export class Nawawi16Component implements OnInit, OnDestroy {
  ...
  isLoadingAudio = false; // المتغير الجديد لمتابعة التحميل
...
ngOnInit() {
  this.titleService.setTitle('الحديث السادس عشر: النهي عن الغضب وضبط النفس - شروح الأربعين النووية');
  
  this.metaService.updateTag({
    name: 'description',
    content: 'شرح وتدبر الحديث السادس عشر (لا تغضب)، وبيان أنواع الغضب الثلاثة (الأخضر والأحمر والأسود)، وطرق علاج الغضب كالتعوذ والوضوء وكظم الغيظ.'
  });
  
  this.metaService.updateTag({
    name: 'keywords',
    content: 'الحديث السادس عشر, النهي عن الغضب, لا تغضب, علاج الغضب, كظم الغيظ, أنواع الغضب, ضبط النفس, شروح الأربعين النووية'
  });
  
  this.metaService.updateTag({ 
    property: 'og:title', 
    content: 'الحديث السادس عشر: النهي عن الغضب - تدبر تفاعلي' 
  });
  
  this.metaService.updateTag({ 
    property: 'og:description', 
    content: 'استمع إلى الحديث الشريف بالتظليل التزامني، وتعرّف على وصية النبي ﷺ الجامعة وجزاء من كظم غيظاً وهو قادر على إنفاذه.' 
  });
