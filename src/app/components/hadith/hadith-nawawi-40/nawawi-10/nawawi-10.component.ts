...
@Component({
  ...
  styleUrl: './nawawi-10.component.css'
})

export class Nawawi10Component implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.titleService.setTitle('الحديث العاشر: إن الله طيب لا يقبل إلا طيبا - شروح الأربعين النووية');
    this.metaService.updateTag({
      name: 'description',
      content: 'شرح وتدبر الحديث العاشر من الأربعين النووية، مع بيان مفردات الحديث وشروط قبول الدعاء، وأثر كسب الحلال على استجابة المناجاة وفضل تحري الطيب.'
    });
    this.metaService.updateTag({
      name: 'keywords',
      content: 'الحديث العاشر, الأربعون النووية, إن الله طيب, كسب الحلال, شروط قبول الدعاء, أكل الطيبات, أداب الدعاء, شرح الحديث العاشر'
    });
    this.metaService.updateTag({ property: 'og:title', content: 'الحديث العاشر: الحلال الطيب شرط القبول - تدبر تفاعلي' });
    this.metaService.updateTag({ property: 'og:description', content: 'اكتشف موانع استجابة الدعاء وأثر المال الحرام، واطلع على تفسير الآيات الواردة في الخطاب الإلهي للرسل والمؤمنين.' });
